...
import { getMonthStart, computeBurnRate } from "./helpers";
export const dashboardMetricsMethods = {
    ...
    calculateBurnRate(this: MetricsRuntime): number {
        return computeBurnRate(this._txByMonthKey, this.monthStart(3).toISOString().slice(0, 7), this.monthStart(0).toISOString().slice(0, 7), 3);
    },

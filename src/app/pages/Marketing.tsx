...
export function Marketing() {
  ...
  function openEdit(m: MarketingMetrics) {
    setForm({ channel_id: m.channel_id ?? "", period_start: m.period_start, period_end: m.period_end, spend: String(m.spend), revenue_generated: String(m.revenue_generated), customers_acquired: String(m.customers_acquired), leads: String(m.leads ?? "") });
    setSelected(m);
    setModal("edit");
  }
